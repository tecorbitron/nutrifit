...
const ConsultBanner = () => {
    return (
        <section className='pt-10 pb-20 px-4'>
            <div className="relative flex flex-col  md:items-end justify-between gap-4 w-full max-w-screen-xl m-auto min-h-80 bg-gradient-to-b from-transparent p-6 to-black/5 bg-gray-600/10 rounded-[40px]">
                <Image src={image} alt='banner image' width={300} height={200} className='md:absolute left-5 h-full rounded-[40px] object-cover -mt-[100px] md:m-auto' />
